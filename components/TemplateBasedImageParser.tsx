...
const DATA_REGIONS: DataRegion[] = [
	...
	// Stats
	{ name: 'speed', x: 100, y: 480, width: 106, height: 56, type: 'stats' },
	{ name: 'stamina', x: 300, y: 480, width: 106, height: 56, type: 'stats' },
	{ name: 'power', x: 500, y: 480, width: 106, height: 56, type: 'stats' },
	{ name: 'guts', x: 700, y: 480, width: 106, height: 56, type: 'stats' },
...
function generateSkillRegions(imageHeight: number, scale: number, offset: { x: number; y: number }): DataRegion[] {
	...
	const startY = 890; // Starting Y position for first skill row
	const leftX = 100; // Left column X position
	const rightX = 600; // Right column X position
	const skillWidth = 360;
	const skillHeight = 71;
